...
@Configuration
@EnableJpaRepositories("com.istic.jhipstervideogen.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.istic.jhipstervideogen.config.HerokuDatabaseConfiguration")
